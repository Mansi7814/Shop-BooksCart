...
import static com.example.my.BooksCart.View.CartActivity.grandTotal;
import static com.example.my.BooksCart.View.CartActivity.grandTotalplus;
import static com.example.my.BooksCart.View.CartActivity.temparraylist;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final CartAdapter.ViewHolder holder, final int position) {
        ...
        requestOptions.placeholder(R.drawable.book_one);
        requestOptions.error(R.drawable.book_one);
